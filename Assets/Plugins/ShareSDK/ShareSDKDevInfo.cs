...
//		public string auth_type = "both";	//can pass "both","sso",or "web"  
    ...
    public class QQ : DevInfo
    {
        ...
        public string AppId = "1109628425";
        public string AppKey = "8INhk7Ede7CO7XSH";
...
//		public string auth_type = "both";  //can pass "both","sso",or "web" 
    ...
    public class WeChat : DevInfo
    {
        ...
        public string AppId = "wx353d37e263cd2ae5";
        public string AppSecret = "e72d398ace5feef48cbdf8c4d7dda6f2";
