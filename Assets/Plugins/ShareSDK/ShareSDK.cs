...
#if UNITY_ANDROID
        public string appKey = "2bd9f2907a396";
        public string appSecret = "b702e2b7ccb5e4a6a9eef0b9ea7fa716";
#elif UNITY_IPHONE
        ...
        void Awake()
        {
            ...
            foreach (FieldInfo devInfoField in devInfoFields)
            {
                ...
                foreach (FieldInfo field in fields)
                {
                    ...
                    else if ("Enable".EndsWith(field.Name) || "ShareByAppClient".EndsWith(field.Name) ||
                             "BypassApproval".EndsWith(field.Name) || "WithShareTicket".EndsWith(field.Name))
                    {
